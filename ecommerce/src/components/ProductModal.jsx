...
import img from "./../assets/img/iphone-11-128gb-chinh-hang_2.jpg";
...
function ProductModal({handleClose, openToastSuccess, openToastError}) {
    ...
    const handleClick = () =>{
        if(color !== "" && size !== ""){
            ...
            let msg = "";
            if(color === "" && size === "")
                msg="Bạn cần chọn màu và dung lượng";
            else if(color === "")
                msg = "Bạn cần chọn màu";
                ...
                <Grid container>
                    ...
                    <Grid item lg={7} md={6} sm={12}>
                        <div className="prodModal__details">
                            ...
                            <p>
                                iPhone 11 với 6 phiên bản màu sắc, camera có
                                khả năng chụp ảnh vượt trội, thời lượng pin
                                cực dài và bộ vi xử lý mạnh nhất từ trước
                                đến nay sẽ mang đến trải nghiệm tuyệt vời
                                dành cho bạn.
                            </p>
                                ...
                                <ul>
                                    {listColor.map((item , idx) =>{
                                        return(
                                            ...
                                            >
                                               <div className={colorIndex === idx? "icon-check": "icon-check hidden-check"}>
                            ...
                            <div className="prodModal__action">
                                <div className="prodModal_add">
                                    <button className="btn" onClick={handleClick}>Thêm vào giỏ</button>
                                </div>
                                <div className="prodModal__checkout">
                                    <button className="btn" onClick={handleClick}>Thanh toán</button>
                                </div>
                            </div>
                        </div>
                    </Grid>
