                ...
                <Grid container>
                    <Grid item xs={12}>
                        <form method="post" action="#">
                            <label htmlFor="name">Full name<span className="required">*</span><br /></label>
                            ...
                            <Grid container spacing={1} className="email-phone">
                                <Grid item lg={5} md={5} xs={12}>
                                    <div className="fname">
                                        <label htmlFor="phone">Phone number<span className="required">*</span><br /></label>
                                ...
                                <Grid item lg={5} md={5} xs={12}>
                                    <label htmlFor="email">Email <span className="required">*</span><br /></label>
                            ...
                            <label htmlFor="address">Address<span className="required">*</span><br /></label>
                            ...
                            <Grid container spacing={4} className="payment">
                                ...
                                <Grid item>
                                    <button type="submit" className="next">Payment</button>
                                </Grid>
                            </Grid>
                        </form>
                    </Grid>
