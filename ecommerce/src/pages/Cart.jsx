			...
			<div className="row">
				<div className="col-md-5">
					<div className="billing-details">
						...
						<div className="form-group">
							...
							<input className="input" type="tel" name="PhoneNumber" onChange={handleChangeBill} required/>
						</div>
						<div className="form-group">
							<label htmlFor="method" >Phương thức thanh toán</label>
								<select className="input" id="method" name="PaymentMethod" defaultValue="momo" >
				...
				<div className="col-md-7 order-details">
					...
					<div className="order-summary">
						...
						<button className=" btn-success my-1" onClick={payment}>Đặt hàng</button>
						</div>
				</div>
			</div>
		</div>
